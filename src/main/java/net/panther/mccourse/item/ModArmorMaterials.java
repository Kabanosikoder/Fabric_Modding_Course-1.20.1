...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    }), 13, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2.0F, 0.0F, () -> Ingredient.ofItems(ModItems.PINK_GARNET));
    ...
    public String getName() {
        return MCCourseMod.MOD_ID + ":" + this.name; // this makes sure the texture is in mccourse mod and not minecraft
    }
